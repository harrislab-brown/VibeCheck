...
#define VC_SENSOR_MAX_PACKET_SIZE 100  /* make sure this fits in the shell overflow region */  /* TODO: have the user set the data per packet on the fly to account for different data rates */
