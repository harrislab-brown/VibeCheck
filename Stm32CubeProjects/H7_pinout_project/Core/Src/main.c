...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : SPI4_INT2_Pin */
  GPIO_InitStruct.Pin = SPI4_INT2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SPI4_INT2_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : BIG_RED_BUTTON_Pin */
  GPIO_InitStruct.Pin = BIG_RED_BUTTON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BIG_RED_BUTTON_GPIO_Port, &GPIO_InitStruct);
